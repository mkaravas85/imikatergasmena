...
Module Module1
    ...
    'Public constr = "server=192.168.1.10;userid=signet;password=enapass;database=dbtechnocan;port=33953;"
    Public date5, formcontrol As String
    Public grammi As Integer = -1
    Public norecordsfound As Boolean = False
    Public username As String
    Public tmima As Integer = 0
    ...
    End Sub
    Public Sub TODATE2(newdate1 As String, ByRef dateext2 As String)
        Dim date3 As String() = newdate1.Split(" ")

        Dim date4 As String() = date3(0).Split("/")
        dateext2 = date4(2) + "-" + date4(1) + "-" + date4(0)
    End Sub
